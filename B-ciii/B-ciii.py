...
if __name__ == "__main__":
    ...
    uiDf = tradeDf.groupby(['vipno', 'dptno'])
    ...
    last_month_ui = get_last_month_record(['vipno', 'dptno'], months)
    ...
    test_last_month_ui = get_last_month_record(['vipno', 'dptno'], test_months)
    ...
    classifiers = [neigh, dtc, abc, rfc, bc, gbc]
    exec_times = []
    precises = []
    classifier_names = []
    for classifier in classifiers:
        ...
        print('Exec Time', exec_time, 's', classifier_name + ' precision: ', precise)
        # write
